...
<html lang="pt-br">
   <head>
      ...
      <title>Barista - editar cafés do catálogo</title>
   </head>
   <body style="background-color: #F0E5CF;">
      ...
      <?php
         ...
         $id = $_GET["idCoffee"];
         $result = searchUpdateProduct($id);
         ?>
      <div class="form my-4 mx-5">
         <div class="container py-5 px-5 mt-5" style="background-color: #F0ECE3;">
            <div class="row gx-0">
               <div class="col-lg-8">
                  <h2 class="py-3 mb-4" style="font-family: 'blackout'; font-size: 3.2em;">Café velho é ruim, faz uma faxina!</h2>
                  <form action="../controller/controllProduct.php" method="post">
                     <div class="form-row">
                        <div class="col-lg-6">
                           <input type="text" id="nameCoffee" name="nameCoffee" value="<?= $result['name_coffee'] ?>" disabled="" placeholder="Nome do café" class="form-control my-3 p-2">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="col-lg-6">
                           <input type="text" id="typeCoffee" name="typeCoffee" value="<?= $result['type_coffee'] ?>" disabled="" placeholder="Tipo do café" class="form-control my-3 p-2">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="col-lg-6">
                           <input type="text" id="priceCoffee" name="priceCoffee" value="<?= $result['price_coffee'] ?>" disabled="" placeholder="Preço do café" class="form-control my-3 p-2">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="col-lg-6">
                           <input type="hidden" name="idCoffee" value="<?= $result['id_coffee'] ?>">
                           <button type="submit" name="option" value="delete" class="mt-2 mb-3 p-2" style="border: none; background-color:#A68DAD; font-size:1.2em; border-radius:10px; outline: none;">Deletar café</button>
                        </div>
                     </div>
                  </form>
               </div>
               <div class="col-lg-4">
                  <img src="../assets/images/coffeeLeaf.png" alt="create-coffee-img" class="mt-5 py-5 pe-5" style="width: 100%;">
               </div>
            </div>
         </div>
      </div>
