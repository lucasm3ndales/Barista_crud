      ...
      <div class="form my-4 mx-5">
         <div class="container py-5 px-5 mt-5" style="background-color: #F0ECE3;">
            <div class="row gx-0">
               ...
               <div class="col-lg-8">
                  <h2 class="py-3 mb-4" style="font-family: 'blackout'; font-size: 3.2em;">Não esquece de atualizar sua coffee list!</h2>
                  <form action="../controller/controllProduct.php" method="post">
                     <div class="form-row">
                        <div class="col-lg-6">
                           <input type="text" id="nameCoffee" name="nameCoffee" value="<?= $result['name_coffee'] ?>" placeholder="Nome do café" class="form-control my-3 p-2">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="col-lg-6">
                     ...
                     <div class="form-row">
                        <div class="col-lg-6">
                           ...
                           <button type="submit" name="option" value="update" class="mt-2 mb-3 p-2" style="border: none; background-color:#A68DAD; font-size:1.2em; border-radius:10px; outline: none;">Atualizar café</button>
                        </div>
                     </div>
                  </form>
               </div>
